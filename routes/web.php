...
Route::get('/messages-list/{message}/up', [App\Http\Controllers\UpdownController::class, 'up']);
Route::get('/messages-list/{message}/down', [App\Http\Controllers\UpdownController::class, 'down']);
