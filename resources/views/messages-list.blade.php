                ...
                @foreach ($messages as $message)
                    ...
                    <div class="col-10 col-md-11">
                        <div class="pt-4 pb-4">
                            ...
                            <a href="/messages-list/{{ $message->id }}/up" class="up"><button type="button" class="btn btn-secondary">Up</button></a>
                            <a href="/messages-list/{{ $message->id }}/down" class="down"><button type="button" class="btn btn-secondary ms-3">Down</button></a>
                        </div>
                    </div>
                @endforeach
                <div class="d-flex">
