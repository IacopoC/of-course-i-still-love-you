        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="input-group mb-4 mt-4">
                    <input type="text" class="form-control w-65" name="updown_message" aria-label="Text input with dropdown button" placeholder="Write here your short texts..." maxlength="155" required>
