...
@section('description')
    Welcome to Of Course I Still Love You, a messages web application to write private text messages, register now or login and start writing your messages.
@endsection
    ...
    <div class="container">
        <div class="p-5 mb-4 bg-dark rounded-3">
            ...
            <div class="container-fluid py-5">
                        ...
                        <p class="col-md-8 fs-5 text-white">A messages web application to write private text messages, register now or login and start writing.</p>
                @guest
